...
namespace QQReborn.App.Services
{
    ...
    public class MockChatService : IChatService
    {
        ...
        public MockChatService()
        {
            ...
            {
                new ChatConversation { Id = "c1", Kind = ConversationKind.Friend, Title = "张三", AvatarPath = FriendAvatar, Preview = "在吗？晚上一起吃饭", LastTime = DateTimeOffset.Now.AddMinutes(-3), Unread = 2 },
                new ChatConversation { Id = "c2", Kind = ConversationKind.Group, Title = "WP 钉子户交流群", AvatarPath = GroupAvatar, Preview = "李四：Lumia 950 永不为奴", LastTime = DateTimeOffset.Now.AddMinutes(-25), Unread = 9 },
        ...
        public Task<IReadOnlyList<ChatMessage>> GetMessagesAsync(string conversationId)
        {
